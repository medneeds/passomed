...
REVOKE ALL ON FUNCTION public.protect_fixed_uti_beds() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.protect_fixed_uti_beds() FROM anon;
REVOKE ALL ON FUNCTION public.protect_fixed_uti_beds() FROM authenticated;